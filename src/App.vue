...
import aboutPhoto from '@/assets/images/about-photo.jpeg';
import poblacion from '@/assets/images/poblacion.png';
import prims from '@/assets/images/prims.png';
import summitGuardian from '@/assets/images/summit-guardian.png';
...
const cvPath = new URL('@/assets/documents/cv.pdf', import.meta.url).href;
...
<template>
  <div>
      ...
      <div v-if="sidebar"
        ...
        <div class="px-2 overflow-y-auto">
          <ul class="space-y-4 font-medium tracking-wider cursor-pointer text-white mb-6">
            ...
            <li>
              <a :class="sideNavlinkClass('services')" @click.prevent="scrollToSection('services')">Services</a>
            </li>
            <li>
              <a :class="sideNavlinkClass('portfolio')" @click.prevent="scrollToSection('portfolio')">Portfolio</a>
            </li>
            <li>
              <a :class="sideNavlinkClass('contact')" @click.prevent="scrollToSection('contact')">Contact</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section id="home"
      class="h-screen flex flex-col md:flex-row items-center bg-auto bg-left bg-no-repeat px-8 bg-gray-950 lg:bg-background-img lg:bg-cover">
      <div
        ...
        <div class="typing-container flex items-center">
          <span class="text text-xl md:text-4xl font-bold text-white">{{ displayedText }}</span>
          <span v-if="isCursorVisible" class="cursor text-xl md:text-4xl font-bold text-white">|</span>
        </div>
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-nowrap">
          ...
          <div class="lg:w-1/2 w-full pl-10 lg:py-6 mt-6 lg:mt-0 slide-in-left">
            <h1 class="text-teal-500 border-b border-teal-500 md:text-3xl title-font font-medium mb-1 text-xs">
              About
            </h1>
        ...
        <div class="flex flex-wrap">
          ...
          <div class="p-4 md:w-1/3 slide-in-bottom">
            <div
              ...
              <img class="lg:h-48 md:h-36 w-full object-cover object-left hidden sm:flex" :src="prims"
                alt="prims-photo">
              <div class="p-2">
          ...
          <div class="p-4 md:w-1/3 slide-in-bottom">
            <div
              class="h-full border-x-2 border-teal-500 shadow-lg shadow-teal-500 border-opacity-60 rounded-lg overflow-hidden">
              <img class="lg:h-48 md:h-36 w-full object-cover object-center hidden sm:flex" :src="poblacion"
                alt="poblacion-website">
              <div class="p-2">
                <div class="flex justify-between items-center">
                  <h2 class="tracking-widest text-xs title-font font-medium text-gray-200 mb-1">WEBAPP
                  </h2>
          ...
          <div class="p-4 md:w-1/3 slide-in-bottom">
            <div
              class="h-full border-x-2 border-teal-500 shadow-lg shadow-teal-500 border-opacity-60 rounded-lg overflow-hidden">
              <img class="lg:h-48 md:h-36 w-full object-cover object-center hidden sm:flex" :src="summitGuardian"
                alt="summit guardian">
              <div class="p-2">
                <div class="flex justify-between items-center">
